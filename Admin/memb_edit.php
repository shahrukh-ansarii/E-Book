...
$q="select * from membership where memb_id='$id'";
...
$row1=mysqli_fetch_array($r);
    if(isset($_POST['submit']))
    {
        ...
        $query = "update membership set memb_name = '$name',memb_discount='$discount' where memb_id = '$id'";
                  ...
                  <form  style="font-family: 'Texturina', serif;" method="POST">
                     <div class="form-group">
                         ...
                         <label>Membership Name</label>
                          <input type="text" class="form-control" required name="MembName" value="<?php echo $row1[1];?>" >
                         <label>Membership discount</label>
                        <input type="text" class="form-control" required name="MembDiscount" value="<?php echo $row1[2];?>">
                     </div>
